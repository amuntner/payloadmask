...
\begin{frame}
  ...
  \begin{itemize}
  \item  Payload mask is a Open Source Tool to generate payload list to bypass Web Application Firewall, you can use a lot list of encodes and techniques to convert your payload list. 
